package io.akkajob.worker.config;

import io.akkajob.worker.util.ConfigUtil;
...
public class ConfigLoader {
     ...
     * Env config key.
     */
    private static final String CONFIG_ENV_KEY = "AKKAJOB_CONFIG_FILE";

    /**
     * Property config key.
     */
    private static final String CONFIG_PROPERTY_KEY = "akkajob.config.file";

    /**
     * Default openjob config file.
     */
    private static final String DEFAULT_CONFIG_FILE = "classpath:akkajob.properties";
